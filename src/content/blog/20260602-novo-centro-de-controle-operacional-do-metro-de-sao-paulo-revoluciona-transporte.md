...
draft: false
---
O novo CCOx do Metrô de São Paulo representa um avanço significativo na gestão do transporte urbano, refletindo tendências globais.
...
O CCOx se destaca por seu videowall de alta definição, com 36 metros de extensão, composto por 90 telas de 55 polegadas. Embora seja um dos maiores da América Latina, é importante verificar se realmente é o maior. Essa tecnologia permite uma visualização integrada e simultânea da circulação dos trens, redes elétricas e sistemas de segurança, ajustando-se dinamicamente a diferentes cenários operacionais. Segundo o <a href="https://www.agenciasp.sp.gov.br/sp-inaugura-centro-de-controle-operacional-do-metro-com-inovacoes-tecnologicas-e-seguranca-integrada/" target="_blank">Governo de São Paulo</a>, a integração de dados dinâmicos auxilia os controladores na tomada de decisões rápidas e precisas.
